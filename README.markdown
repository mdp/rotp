...
A ruby library for generating one time passwords according to [ RFC 4226 ](http://tools.ietf.org/html/rfc4226) and the [ TOTP RFC ](http://tools.ietf.org/html/draft-mraihi-totp-timebased-00)
